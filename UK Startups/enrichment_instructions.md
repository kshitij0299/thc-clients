Enrichment Instructions for 2026 UK Startup Funding Leads
=========================================================

Goal
----

Given a base list of **UK startups that raised funding in 2026**, enrich each row so it is ready for outreach to founders and key hiring decision makers.
...
1. **Open the funding source URL**.
   - Confirm:
     - The company is UK-headquartered or UK-origin with substantial UK presence.
