US Startup Funding 2026 Research Agent
======================================

Objective
---------

Build and maintain a high-quality, outreach-ready dataset of **US startups that raised funding in 2026**, with enriched founder/decision-maker contacts and hiring signals.

Scope
-----

- Geography: US-headquartered or US-origin startups with substantial US operations.
...
1. **Discover Startups**
   - Use multiple source types:
     - Weekly/Monthly funding roundups (e.g., TechCrunch, Crunchbase News, Axios Pro Rata, PitchBook, VentureBeat).
...
- `\"<startup name>\" raises\" site:techcrunch.com`
- `\"<startup name>\" raises\" site:crunchbase.com`
