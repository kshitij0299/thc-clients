Enrichment Instructions for 2026 Indian Startup Funding Leads
=============================================================

Goal
----

Given a base list of **Indian startups that raised funding in 2026**, enrich each row so it is ready for outreach to founders and key hiring decision makers.
...
1. **Open the funding source URL**.
   - Confirm:
     - The company is Indian or India-origin with substantial India presence.
