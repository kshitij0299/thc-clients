Indian Startup Funding 2026 Research Agent
==========================================

Objective
---------

Build and maintain a high-quality, outreach-ready dataset of **Indian startups that raised funding in 2026**, with enriched founder/decision-maker contacts and hiring signals.

Scope
-----

- Geography: India-headquartered or India-origin startups with substantial India operations.
...
1. **Discover Startups**
   - Use multiple source types:
     - Weekly/Monthly funding roundups (e.g., YourStory, Inc42, Entrackr, BW Disrupt, Economic Times, Entrepreneur India).
...
- `\"<startup name>\" raises\" site:yourstory.com`
- `\"<startup name>\" raises\" site:inc42.com`
